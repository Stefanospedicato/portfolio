...
const About = () => {
  return (
    <section className="w-full flex flex-col items-center justify-center min-h-screen pt-20 xl:flex-row xl:justify-between homepage-section gap-10">
      <ImageSection />
      <div className="w-full xl:w-[50%] h-screen flex flex-col items-center text-center justify-center overflow-auto px-20">
        <p className="text-8xl font-bold mb-10 xl:text-9xl flex-shrink-0">SU DI ME</p>
