...
const ProjectDetail = () => {
  ...
  return (
    <section className="w-full flex flex-col items-center justify-center min-h-screen pt-20 xl:flex-row xl:items-start xl:justify-between homepage-section overflow-y-auto gap-10 mb-20">
      <ImageSection />
      <motion.div
